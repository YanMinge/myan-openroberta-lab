...
export const MATATABOT_MOTION_FORWARD_STEP: string = "matatabotMotionForwardStep";
export const MATATABOT_MOTION_BACKWARD_STEP: string = "matatabotMotionBackwardStep";
export const MATATABOT_MOTION_TURN_LEFT_ANGLE: string = "matatabotMotionTurnLeftAngle";
export const MATATABOT_MOTION_TURN_RIGHT_ANGLE: string = "matatabotMotionTurnRightAngle";
export const MATATABOT_MOTION_MOVING: string = "matatabotMotionMoving";
