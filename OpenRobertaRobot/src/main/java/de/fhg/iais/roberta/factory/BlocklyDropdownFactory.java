...
import de.fhg.iais.roberta.mode.action.MatataBotMotionStep;
import de.fhg.iais.roberta.mode.action.MatataBotMotionAngle;
...
public class BlocklyDropdownFactory {
    ...
    public IMatataBotMotionStep getMatataBotMotionStep(String step) {
        return BlocklyDropdownFactoryHelper.getModeValue(step, MatataBotMotionStep.class);
    }

    public IMatataBotMotionAngle getMatataBotMotionAngle(String angle) {
        return BlocklyDropdownFactoryHelper.getModeValue(angle, MatataBotMotionAngle.class);
    }
}
