...
public class ExprlyTypechecker<T> {
    ...
    static {
        ...
        HashSet<String> matatabot = new HashSet<>();
        ...
        matatabot.add("#FF1493");
        matatabot.add("#800080");
        matatabot.add("#4876FF");
        matatabot.add("#00FFFF");
        matatabot.add("#90EE90");
        matatabot.add("#008000");
        matatabot.add("#FFFF00");
        matatabot.add("#FFA500");
        matatabot.add("#FF0000");
        matatabot.add("#FFFFFE");
        matatabot.add("#FFFFFF");
        matatabot.add("noList");
        matatabot.add("noTernary");
        map.put("matatabot", matatabot);
