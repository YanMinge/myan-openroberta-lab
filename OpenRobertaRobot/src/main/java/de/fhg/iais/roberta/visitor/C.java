...
public class C {
    ...
    public static final String MATATABOT_MOTION_FORWARD_STEP = "matatabotMotionForwardStep";
    public static final String MATATABOT_MOTION_BACKWARD_STEP = "matatabotMotionBackwardStep";
    public static final String MATATABOT_MOTION_TURN_LEFT_ANGLE = "matatabotMotionTurnLeftAngle";
    public static final String MATATABOT_MOTION_TURN_RIGHT_ANGLE = "matatabotMotionTurnRightAngle";
    public static final String MATATABOT_MOTION_MOVING = "matatabotMotionMoving";
}
